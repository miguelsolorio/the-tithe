...
- [~] Creature models and animation (subagent, Opus)
- [x] Props: 52 house furniture and cult props (subagent, Opus)
- [~] Props: depths props, key items, weapons, first-person arms (subagent, Opus)
...
- [~] Abandoned, falling-apart cabin with candlelight inside, surrounded by trees and branches (subagent, Opus; requested mid-build)
...
- [ ] Play-through with final textures, props, models and audio; commit
